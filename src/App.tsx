// React single-file page for Daniel Machado Pintos — Resume Summary
// Drop this component into a React app (Vite/CRA/Next static page) and render it.
// TailwindCSS classes used (optional). If you don't use Tailwind, replace classes with your CSS.
